...
import com.DrakeN.trading.Service.AssetService;
...
public class AssetController {
    ...
    @GetMapping()
    public ResponseEntity<List<Asset>> getAllAssets(@RequestHeader("Authorization") String jwt) throws Exception {

        User user= userService.findUserProfileByJwt(jwt);
        List<Asset> assetList = assetService.getUserAssets(user.getId());
